---
title: "Design Principles for {packageReview}"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Design Principles for {packageReview}}
...
This vignette outlines the design decisions that have been taken during the development of the `{packageReview}` R package, and provides some of the reasoning, and possible pros and cons of each decision.
